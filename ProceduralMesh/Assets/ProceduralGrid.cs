...
public class ProceduralGrid : MonoBehaviour {
    ...
    {
        //set array sizes
        vertices = new Vector3[gridSize * gridSize * 4]; //square grids.. could be gridSizeX and gridSizeY for example
    ...
    {
        //set array sizes
        vertices = new Vector3[(gridSize + 1) * (gridSize + 1)]; //square grids.. could be gridSizeX and gridSizeY for example
        triangles = new int[gridSize * gridSize * 6];
        ...
        for (int x = 0; x <= gridSize; x++){
            for (int y = 0; y <= gridSize; y++){
                vertices[v] = new Vector3((x * cellSize) - vertexOffset, (x + y*y) * 0.2f, (y * cellSize) - vertexOffset);
                v++;
            }
        }
