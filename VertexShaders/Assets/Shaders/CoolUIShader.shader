		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				float2 offset = float2(
					tex2D( _NoiseTex, float2(IN.worldPosition.y / _DistortionSpreader, _Time[0]/ _TimeDamper)).r,
					tex2D( _NoiseTex, float2(_Time[0]/ _TimeDamper, IN.worldPosition.x / _DistortionSpreader)).r);
